...
<font style="color:rgba(0, 0, 0, 0.85);">可以使用多线程或异步编程的方式来同时采集三个数据源的数据，然后再将它们组合起来返回。以 Java 中的 `<font style="color:rgba(0, 0, 0, 0.85);">CompletableFuture`<font style="color:rgba(0, 0, 0, 0.85);"> 为例：
