...
## <font style="background-color:rgba(255, 255, 255, 0);">设计一个基于 byte[]，遵循 FIFO 读取的缓冲区，要求不能有 byte[] 之外的变量</font>
```java
...
## <font style="background-color:rgba(255, 255, 255, 0);">如何实现股票价格的实时变化</font>
